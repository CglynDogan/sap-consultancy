    ...
    <Layout companyName="Tech Solutions" variant="tech-solutions" buttonText="Contact Us">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em]">Send us a message</h2>
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em]">Get in touch</h2>
          
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-4 p-4 border border-[#dbe0e6] rounded-lg">
