    ...
    <Layout companyName="Tech Solutions" variant="tech-solutions" buttonText="Request a Consultation">
      ...
      <div className="flex flex-wrap justify-between gap-3 p-3 xs:p-4">
        <div className="flex min-w-0 flex-col gap-3 w-full">
          <p className="text-[#111418] tracking-light text-xl xs:text-2xl sm:text-3xl lg:text-[32px] font-bold leading-tight">Our SAP Consultancy Services</p>
      ...
      {/* Services Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xs:gap-6 p-3 xs:p-4">
        <div id="implementation" className="flex flex-col gap-4 p-4 xs:p-6 border border-[#dbe0e6] rounded-lg">
        ...
        <div id="consulting" className="flex flex-col gap-4 p-4 xs:p-6 border border-[#dbe0e6] rounded-lg">
        ...
        <div id="support" className="flex flex-col gap-4 p-4 xs:p-6 border border-[#dbe0e6] rounded-lg">
        ...
        <div id="migration" className="flex flex-col gap-4 p-4 xs:p-6 border border-[#dbe0e6] rounded-lg">
